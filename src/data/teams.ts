...
export const teams: Team[] = [
  ...
  },
  {
    ...
    livery: { body:'#e80020', sidepod:'#e80020', engineCover:'#f3f1ed', wing:'#171717', accent:'#ffd21e', accent2:'#f3f1ed', halo:'#e80020', finish:'gloss' },
  ...
  },
  {
    ...
    primaryColor: '#162b55', secondaryColor: '#f1f2f1', logo: '/assets/teams/redbull/logo.webp',
    livery: { body:'#162b55', sidepod:'#162b55', engineCover:'#13254a', wing:'#f2f3f2', accent:'#f6c900', accent2:'#e3232a', halo:'#162b55', finish:'gloss' },
  ...
  },
  {
    ...
    livery: { body:'#f1f1ef', sidepod:'#171717', engineCover:'#f1f1ef', wing:'#171717', accent:'#d71920', accent2:'#f1f1ef', halo:'#171717', finish:'gloss' },
